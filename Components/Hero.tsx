...
const Hero = () => {
    return (
        <section className="relative bg-linear-to-br from-blue-50 to-white overflow-hidden min-h-[80vh] flex items-center pt-10 md:pt-5">
            {/* Background Pattern */}
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col-reverse md:flex-row items-start md:items-center gap-8 md:gap-12">
                ...
                <div className="w-full md:w-1/2 text-right md:pr-10 order-2 md:order-1">
                    ...
                    {/* Main Hero Title */}
                    <h1 className="text-5xl md:text-6xl xl:text-7xl font-extrabold text-[#00aae6] leading-tight mb-8">
                        جمالك يبدأ من هنا.
                        <br />
                        {/* <span className="text-[#00aae6] block md:inline">
                            عناية متكاملة لبشرتك،
                        </span>{" "}
                    ...
                    <p className="text-gray-600 text-lg md:text-xl mb-5 leading-relaxed font-medium max-w-lg ml-auto">
                        نقدّم رعاية متكاملة في الجلدية والتجميل باستخدام أحدث
                        التقنيات، ونحرص على تزويدكم بخطط علاجية وتجميلية مصممة
                        لتلبية احتياجاتكم بدقة واهتمام.
                    </p>
                </div>

                {/* FORM */}
                <div className="relative w-full md:w-1/2 flex justify-center md:justify-end order-1 md:order-2 pb-10 md:pb-0">
